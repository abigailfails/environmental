...
@OnlyIn(Dist.CLIENT)
public class FennecFoxHeldItemLayer extends LayerRenderer<FoxEntity, FennecFoxModel<FoxEntity>> {
	public FennecFoxHeldItemLayer(IEntityRenderer<FoxEntity, FennecFoxModel<FoxEntity>> p_i50938_1_) {
		super(p_i50938_1_);
	}
